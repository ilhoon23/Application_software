...
public class jupiter_rotation : MonoBehaviour
{
    GameObject planets;
    private int real;
    ...
    void Update()
    {
        ...
        {
            transform.RotateAround(Vector3.zero, Vector3.up, 0.833f * Time.deltaTime);
            transform.Rotate(new Vector3(0, -48, 0) * Time.deltaTime);
